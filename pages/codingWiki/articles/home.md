# Simple Coding Wiki Home

This is a simple wiki site thats dedicated to provide basic coding help.

This can range from how to create certain calculations, using features and more.

The main goal is to provide a platform that could help and to be refered to when in need of help or ideas.

__This is still a work in progress project.__
